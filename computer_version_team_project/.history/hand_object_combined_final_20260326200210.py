...
# Check if hand model exists, if not download it
hand_model_path = 'yolov8n-hand.pt'
if not os.path.exists(hand_model_path):
    print(f"Downloading hand model {hand_model_path}...")
    from ultralytics import YOLO
    # This will auto-download the model
    temp_model = YOLO('yolov8n-hand.pt')
    print("Hand model downloaded")

yolo_detect = YOLO('yolov8m.pt')  # Object detection - Medium model
